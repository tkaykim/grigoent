...
const translations = {
  ko: {
    ...
    // 댄서 에이전시 풀 모집
    'applyDancer.pageTitle': 'deetz 댄서 프로필 등록',
    'applyDancer.title': '지원서 작성',
    'applyDancer.subtitle':
      'GRIGO ENTERTAINMENT가 운영하는 댄서 에이전시 풀 deetz에 가입하고 프로필·포트폴리오를 등록합니다.',
    ...
    'applyDancer.birthYearPlaceholder': '년도',
    'applyDancer.birthMonthPlaceholder': '월',
    'applyDancer.birthDayPlaceholder': '일',
    ...
    'applyDancer.privacyConsent': 'deetz 가입, 프로필 등록, 프로젝트 매칭을 위한 이용약관 및 개인정보 처리방침에 동의합니다',
    ...
    'applyDancer.submit': 'deetz 프로필 등록',
    'applyDancer.sending': '제출 중...',
    'applyDancer.success': 'deetz 프로필이 등록되었습니다. 매칭 시 연락드리겠습니다.',
    ...
    'applyDancer.emailHint': 'deetz 로그인과 계약·공고 안내에 사용됩니다.',
    'applyDancer.errorEmail': '올바른 이메일을 입력해 주세요.',
    'applyDancer.password': '비밀번호',
    'applyDancer.passwordHint': 'deetz 로그인에 사용할 비밀번호입니다. 8자 이상 입력해 주세요.',
    'applyDancer.passwordConfirm': '비밀번호 확인',
    'applyDancer.errorPassword': '비밀번호는 8자 이상 72자 이하로 입력해 주세요.',
    'applyDancer.errorPasswordConfirm': '비밀번호가 일치하지 않습니다.',
    'applyDancer.errorDuplicateEmail': '이미 deetz에 가입된 이메일입니다. deetz에서 로그인 후 프로필을 수정해 주세요.',
    ...
    'applyDancer.successTitle': 'deetz 프로필 등록이 완료되었습니다',
    'applyDancer.successBody': '입력하신 이메일과 비밀번호로 deetz에 로그인할 수 있습니다. 프로필은 프로젝트 매칭과 섭외 연락에 사용됩니다.',
    'applyDancer.successTicket': '프로필 번호',
    'applyDancer.loginDeetz': 'deetz 로그인하기',
  ...
  en: {
    ...
    // Dancer agency pool
    'applyDancer.pageTitle': 'Create your deetz dancer profile',
    'applyDancer.title': 'Application form',
    'applyDancer.subtitle':
      'Join deetz, the dancer agency pool operated by GRIGO ENTERTAINMENT, and submit your profile and portfolio.',
    'applyDancer.noticeIntro':
    ...
    'applyDancer.birthYearPlaceholder': 'Year',
    'applyDancer.birthMonthPlaceholder': 'Month',
    'applyDancer.birthDayPlaceholder': 'Day',
    ...
    'applyDancer.privacyConsent': 'I agree to the Terms of Service and Privacy Policy for deetz signup, profile registration, and project matching',
    ...
    'applyDancer.submit': 'Create deetz profile',
    'applyDancer.sending': 'Submitting...',
    'applyDancer.success': 'Your deetz profile has been created. We will contact you when there is a match.',
    ...
    'applyDancer.emailHint': 'Used for deetz login, contracts, and project updates.',
    'applyDancer.errorEmail': 'Please enter a valid email address.',
    'applyDancer.password': 'Password',
    'applyDancer.passwordHint': 'Use this password to log in to deetz. Minimum 8 characters.',
    'applyDancer.passwordConfirm': 'Confirm password',
    'applyDancer.errorPassword': 'Password must be 8 to 72 characters.',
    'applyDancer.errorPasswordConfirm': 'Passwords do not match.',
    'applyDancer.errorDuplicateEmail': 'This email is already registered on deetz. Please log in to deetz and edit your profile there.',
    ...
    'applyDancer.successTitle': 'Your deetz profile is ready',
    'applyDancer.successBody': 'You can log in to deetz with the email and password you entered. Your profile will be used for project matching and casting contact.',
    'applyDancer.successTicket': 'Profile number',
    'applyDancer.loginDeetz': 'Log in to deetz',
  ...
  ja: {
    ...
    // Dancer agency pool
    'applyDancer.pageTitle': 'deetz ダンサープロフィール登録',
    'applyDancer.title': '応募フォーム',
    'applyDancer.subtitle':
      'GRIGO ENTERTAINMENTが運営するダンサーエージェンシープール deetz に登録し、プロフィール・ポートフォリオを提出します。',
    'applyDancer.noticeIntro':
    ...
    'applyDancer.birthYearPlaceholder': '年',
    'applyDancer.birthMonthPlaceholder': '月',
    'applyDancer.birthDayPlaceholder': '日',
    ...
    'applyDancer.privacyConsent': 'deetz登録、プロフィール作成、プロジェクトマッチングのための利用規約およびプライバシーポリシーに同意します',
    ...
    'applyDancer.submit': 'deetzプロフィール登録',
    'applyDancer.sending': '送信中...',
    'applyDancer.success': 'deetzプロフィールを登録しました。マッチングが発生次第ご連絡いたします。',
    'applyDancer.errorRequired':
    ...
    'applyDancer.emailHint': 'deetzログイン、契約、募集案内に使用します。',
    'applyDancer.errorEmail': '有効なメールアドレスを入力してください。',
    'applyDancer.password': 'パスワード',
    'applyDancer.passwordHint': 'deetzログイン用のパスワードです。8文字以上で入力してください。',
    'applyDancer.passwordConfirm': 'パスワード確認',
    'applyDancer.errorPassword': 'パスワードは8〜72文字で入力してください。',
    'applyDancer.errorPasswordConfirm': 'パスワードが一致しません。',
    'applyDancer.errorDuplicateEmail': 'このメールアドレスはすでにdeetzに登録されています。deetzにログインしてプロフィールを編集してください。',
    ...
    'applyDancer.successTitle': 'deetzプロフィール登録が完了しました',
    'applyDancer.successBody': '入力したメールアドレスとパスワードでdeetzにログインできます。プロフィールはプロジェクトマッチングとキャスティング連絡に使用されます。',
    'applyDancer.successTicket': 'プロフィール番号',
    'applyDancer.loginDeetz': 'deetzにログイン',
