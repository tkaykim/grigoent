...
> = {
  ko: {
    ...
    invalid_or_expired: '결제 링크가 올바르지 않습니다. 링크가 중간에 잘렸을 수 있으니 메일의 링크를 다시 눌러 주세요.',
  ...
  en: {
    ...
    invalid_or_expired: 'This payment link is not valid. It may have been cut off — please open the link from your email again.',
  ...
  ja: {
    ...
    invalid_or_expired: '決済リンクが正しくありません。途中で切れている可能性がありますので、メールのリンクをもう一度お開きください。',
